     ...
     function SetnewTEXT(ISA){
       switch (ISA) { //Aqui ele vai ver qual deus vai ganhar pontos.
          case 1:
            ...
            break;
          case 2:     
          document.getElementById("pergunta").innerHTML = "Pra mim festa tem que ser:";
          document.getElementById("answerGroup_0").innerHTML = "Open bar né porque ninguém merece gastar dinheiro com bebida em rolê";
          document.getElementById("answerGroup_1").innerHTML = "Não bebo então prefiro que não seja open bar";
          document.getElementById("answerGroup_2").innerHTML = "Pra mim tanto faz o negócio é festa";
          ...
          document.getElementById("answerGroup_6").innerHTML = "";
          document.getElementById("answerGroup_7").innerHTML = "";
            break;
          case 3:
          //oitavo já foi liberado na questão anterior!
          document.getElementById("pergunta").innerHTML = "Nas festas eu costumo:";
          document.getElementById("answerGroup_0").innerHTML = "Beijo todo mundo que eu vejo pela frente";
          document.getElementById("answerGroup_1").innerHTML = "Sou bem seletiva mas não saio no 0x0";
          document.getElementById("answerGroup_2").innerHTML = "Não gosto de ficar beijando qualquer um";
          document.getElementById("answerGroup_3").innerHTML = "";
          document.getElementById("answerGroup_4").innerHTML = "";
          document.getElementById("answerGroup_5").innerHTML = "";
          document.getElementById("answerGroup_6").innerHTML = "";
          document.getElementById("answerGroup_7").innerHTML = "";
          document.getElementById("answerGroup_8").innerHTML = "";
          document.getElementById("answerGroup_9").innerHTML = "";
          document.getElementById("answerGroup_10").innerHTML = "";
          document.getElementById("answerGroup_11").innerHTML = "";
            break;
          case 4:
          document.getElementById("pergunta").innerHTML = "Você geralmente:";
          document.getElementById("answerGroup_0").innerHTML = "Bebo com sabedoria pra nunca passar mal";
          document.getElementById("answerGroup_1").innerHTML = "Posso misturar todas as bebidas do open bar que fico suave o rolê inteiro";
          document.getElementById("answerGroup_2").innerHTML = "Bebo como se o mundo fosse acabar";
          document.getElementById("answerGroup_3").innerHTML = "";
          document.getElementById("answerGroup_4").innerHTML = "";
            break;
          case 5:
          document.getElementById("pergunta").innerHTML = "Não abro mão que a festa seja:";
          document.getElementById("answerGroup_0").innerHTML = "No Pantanal";
          document.getElementById("answerGroup_1").innerHTML = "Em qualquer lugar decente com banheiro limpo";
          document.getElementById("answerGroup_2").innerHTML = "Qualquer lugar, eu rodo o mundo se precisar";
          document.getElementById("answerGroup_3").innerHTML = "";
          document.getElementById("answerGroup_4").innerHTML = "";
          document.getElementById("answerGroup_5").innerHTML = "";
          document.getElementById("answerGroup_6").innerHTML = "";
